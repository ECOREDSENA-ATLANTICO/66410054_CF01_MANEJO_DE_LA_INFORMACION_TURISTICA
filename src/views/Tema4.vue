...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .row
        .col-lg-6
          .tarjeta-avatar-b.mb-5
            ...
            .tarjeta.tarjeta--azul
              .p-4         
                p <b>Recurso:</b> Factores físicos y culturales potencialmente explotables por el turismo.
        ...
        .col-lg-6
          .tarjeta-avatar-b.mb-5
            ...
            .tarjeta.tarjeta--azul
              .p-4
                p <b>Atractivo:</b> Factores físicos y culturales que reúnen las condiciones para ser integrados de inmediato a los productos turísticos. 
    ...
    .row.pe-lg-3.justify-content-center.mb-4(data-aos="zoom-in")
      ...
      .col.px-0
        h3.mb-0 Clasificación de los bienes y atractivos
    ...
    TabsA.color-acento-botones.mb-5
      ...
      .tarjeta.color-acento-botones--borde.p-4(titulo="Patrimonio Cultural")
        .row.justify-content-center.align-items-center.px-lg-4.px-md-1
            .col-lg-7   
      ...
      .tarjeta.color-acento-botones--borde.p-4(titulo="Patrimonio material")
        .row.justify-content-center.align-items-center.px-lg-4.px-md-1
            .col-lg-7 
              h3 Patrimonio material:            
      ...
      .tarjeta.color-acento-botones--borde.p-4(titulo="Patrimonio inmaterial")
        .row.justify-content-center.align-items-center.px-lg-4.px-md-1
            .col-lg-7  
              h3 Patrimonio inmaterial          
      ...
      .tarjeta.color-acento-botones--borde.p-4(titulo="Festividades y eventos")
        .row.justify-content-center.align-items-center.px-lg-4.px-md-1
            .col-lg-7 
              h3 Festividades y eventos            
      ...
      .tarjeta.color-acento-botones--borde.p-4(titulo="Sitios naturales")
        .row.justify-content-center.align-items-center.px-lg-4.px-md-1
            .col-lg-7   
              h3 Sitios naturales         
