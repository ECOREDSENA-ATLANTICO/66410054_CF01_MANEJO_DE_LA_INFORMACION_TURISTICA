      ...
      .col-lg-8
        .row.pe-lg-3.justify-content-center(data-aos="zoom-in")
          .col-auto.pe-2.mt-1.fnd-t-2.fnd-t
            h5 Criterios para la valoración del patrimonio cultural


    .row.justify-content-center.align-items-center.mb-5(data-aos="fade-right")
      .col-xl-8.fnd-6.fnd-6-
        .row.align-items-center.fnd-5
          .col-xl-9.col-lg-9
            p.mb-0 <b>Calidad:</b> para calificar la calidad de estos bienes es importante tener en cuenta la categorización: “clasificación de los bienes y atractivos” y los criterios que se enuncian a continuación:
        ...
        .row.justify-content-center.align-items-center.mb-5.fnd-8-4
          ...
          .col-lg-8
            .row.pe-lg-3(data-aos="zoom-in")
              ...
              .col.px-0
                p.mb-0 Reconocer el recurso o de atractivo turístico frente a mercados turísticos en el ámbito local, regional, nacional o internacional.
            .row.pe-lg-3(data-aos="zoom-in")
              .col-auto.pe-2.mt-1
                img(src="@/assets/curso/temas/tema5/check.svg")
              .col.px-0
                p.mb-0 Definir qué bienes culturales o naturales son recursos y cuáles atractivos.
            .row.pe-lg-3(data-aos="zoom-in")
              .col-auto.pe-2.mt-1
                img(src="@/assets/curso/temas/tema5/check.svg")
              .col.px-0
                p.mb-0 Establecer acciones de diseño y caracterización del producto turístico del destino.
            .row.pe-lg-3(data-aos="zoom-in")
              .col-auto.pe-2.mt-1
                img(src="@/assets/curso/temas/tema5/check.svg")
              .col.px-0
                p.mb-0 Determinar los mercados a los cuales se puede acceder con acciones de promoción y comercialización.
            .row.pe-lg-3(data-aos="zoom-in")
              .col-auto.pe-2.mt-1
                img(src="@/assets/curso/temas/tema5/check.svg")
              .col.px-0
